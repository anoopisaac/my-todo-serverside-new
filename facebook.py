...
class FacebookHandler(BaseHandler):
    ...
    REDIRECT_URL = 'http://hello12345.test.com:8080/fbsignin'
    ...
    def get(self):
        ...
        if self.request.get('code') :
            ...
            print("auth code....")
            user_data = self.user_model.create_user('hello@gmail.com',
                                                    None,
                                                    email_address='hello@gmail.com', name=name,
                                                    last_name=last_name, verified=True)
            logging.warning("user data %r...%r",user_data[0],user_data[1])                                       
